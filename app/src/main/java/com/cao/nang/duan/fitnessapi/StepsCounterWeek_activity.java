...
public class StepsCounterWeek_activity extends AppCompatActivity {
    public static final String TAG = "BasicHistoryApi";
    private static final int REQUEST_OAUTH_REQUEST_CODE = 1;
    private static final int REQUEST_OAUTH_REQUEST_CODEA = 0x1001;
    private TextView tinhkmtuan;
    private TextView tinhcalotuan;
    private TextView tvSobuoctuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_steps_counter_week_activity);
        tinhkmtuan = (TextView) findViewById(R.id.tinhkmtuan);
        tinhcalotuan = (TextView) findViewById(R.id.tinhcalotuan);
        tvSobuoctuan = (TextView) findViewById(R.id.tvSobuoctuan);
        fit();
...
//tạo thời gian
    ...
    public void homnayt(View view) {
        Intent intent=new Intent(StepsCounterWeek_activity.this, StepCounter_activity.class);
